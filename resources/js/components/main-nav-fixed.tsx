    ...
    <div className="flex flex-col w-full py-2">
      ...
      <div className="flex justify-between items-center w-full mb-3">
        ...
        <div className="flex items-center">
          {/* Language Switcher - Visible on all screen sizes except mobile */}
          <div className="hidden md:flex items-center mr-2 sm:mr-3 flex-shrink-0">
            <LanguageSwitcher />
          </div>

          {/* Accessibility Toggle - Only visible on desktop */}
          <div className="hidden lg:flex items-center mr-2 lg:mr-3 xl:mr-4 flex-shrink-0">
            <AccessibilityToggle />
          </div>

          {/* Apply Button - Visible on all screen sizes except mobile */}
          <div className="hidden md:flex items-center flex-shrink-0">
            <Link
              href="/application"
              className="bg-gradient-to-r from-[#FF6600] to-[#FF8800] hover:opacity-90 text-white px-2 sm:px-3 lg:px-4 py-1.5 lg:py-2 rounded-md transition-colors text-xs sm:text-sm lg:text-base font-medium whitespace-nowrap"
            >
